...
enum BikramSambat {
    ...
    /// Return the BS equivalent of any Gregorian `Date`, interpreted in Nepal time.
    ...
    static func bsDate(from date: Date) -> BSDate {
    ...
    /// Convenience: BS date for "now" in Nepal time.
